...
const add = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let newCustomerServices = new _validation_1.customerServices();
    newCustomerServices.userId = new mongoose_1.default.Types.ObjectId(req.body.userId);
    ...
    newCustomerServices = yield newCustomerServices.save();
