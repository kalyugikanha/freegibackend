...
exports.validateLogin = exports.validateVerify = exports.validateSignup = exports.validateMobile = exports.PinCode = exports.Users = void 0;
...
const validateLogin = (data) => {
    const schema = joi_1.default.object({
        mobileNumber: joi_1.default.string().required().label("Mobile"),
        password: joi_1.default.string().required().label("Password"),
    });
    return schema.validate(data, { abortEarly: false, allowUnknown: true });
};
