...
const add = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (error)
            throw error;
        let product = yield _validation_1.FreeProduct.findOne({ name: req.body.name });
        if (product)
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (productName)
        return res.status(400).json({ error: { name: "Name is already exists." } });
    let product = yield _validation_1.FreeProduct.findOne({ _id: req.params.id });
    if (!product) {
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let check = yield _validation_1.FreeProduct.findOne({ _id: id });
        if (!check) {
            throw new Error("No record found.");
        }
        yield _validation_1.FreeProduct.deleteOne({ _id: id });
