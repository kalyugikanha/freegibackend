...
exports.validateDelete = exports.validateStatus = exports.validateUpdate = exports.validateAdd = exports.Product = void 0;
...
const validateAdd = (data) => {
    const schema = joi_1.default.object({
        ...
        subCategory: joi_1.default.string().hex().length(24).required().label("sub-category"),
    });
